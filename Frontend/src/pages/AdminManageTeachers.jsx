  ...
  return (
    <div className="container py-5 fade-in-up">
      ...
      <div className="d-flex justify-content-between align-items-center mb-5">
        ...
        <button
          className="btn btn-success text-white shadow-sm hover-glow px-4 rounded-pill"
          onClick={openModal}
        >
              ...
              {teachers.length > 0 ? (
                teachers.map((teacher) => (
                  <tr key={teacher.teacherId}>
                    ...
                    <td>
                      <span className="badge bg-light text-success border border-success-subtle px-3">
                        {teacher.subject}
                      </span>
                    </td>
                    <td>
                ...
                <div className="modal-body p-4">
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      placeholder="e.g. Advanced Physics, Literature"
                      required
                    />
                  </div>
                </div>
            ...
            <div className="modal-content glass-modal border-0 shadow-lg text-center p-4">
              <div className="modal-body">
                ...
                <p className="text-muted mb-4">
                  Are you sure you want to delete this teacher profile? This
                  cannot be undone.
                </p>
