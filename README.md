...
```properties
spring.datasource.url=jdbc:postgresql://localhost:5432/schoolsync_db
...
1. Build the JAR file:
   ...
   mvn clean package
   ```
2. Deploy the JAR to your hosting platform (Heroku, AWS, Azure, etc.)
...
A sample admission request is available in `backend/test-admission.json` for testing the admission endpoint.
